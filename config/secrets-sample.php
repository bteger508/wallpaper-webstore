<!-- Copy all the code below this line to your own 'secrets.php' in this config directory -->

<!-- Remember to use `include 'secrets.php'` in each php file that needs these variables -->
...
DEFINE ('DB_PORT', ''); // 3306 (not needed)